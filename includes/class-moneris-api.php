...
class mpgSessionAccountInfo {
	...
	var $params;
	var $sessionAccountInfoTemplate = array(
		'policy',
		'account_login',
		'password_hash',
		'account_number',
...
class mpgAttributeAccountInfo {
	...
	var $params;
	var $attributeAccountInfoTemplate = array(
		'device_id',
		'account_login',
		'password_hash',
		'account_number',
...
class mpgAxRaLevel23 {
	...
	public function setAxRaLevel23(
		$airline_process_id,
		$invoice_batch,
		$establishment_name,
		$carrier_name,
...
class vsTripLegInfo {
	...
	public function setTripLegInfo(
		$coupon_number,
		$carrier_code1,
		$flight_number,
		$service_class,
