...
const config = {
	entry: {
		'give-moneris-admin': [
			'./assets/src/js/admin/give-moneris-admin.js',
			'./assets/src/css/admin/give-moneris-admin.scss',
		],
		'give-moneris': [
			'./assets/src/js/frontend/give-moneris.js',
			'./assets/src/css/frontend/give-moneris-frontend.scss',
		],
	},
